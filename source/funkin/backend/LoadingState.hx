...
class LoadingState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		funkay.setGraphicSize(Std.int(CoolUtil.coolLerp(FlxG.width * 0.88, funkay.width, 0.9)));
		funkay.updateHitbox();
		// funkay.updateHitbox();
		...
		if (callbacks != null)
		{
			...
			loadBar.scale.x = CoolUtil.coolLerp(loadBar.scale.x, targetShit, 0.50);
	...
	{
		return Paths.getLibraryPathForce(PlayState.SONG.song.toLowerCase() + "/Inst" + Paths.SOUND_EXT, "songs");
		// return Paths.inst(PlayState.SONG.song);
	}

	static function getVocalPath()
	{
		return Paths.getLibraryPathForce(PlayState.SONG.song.toLowerCase() + "/Voices" + Paths.SOUND_EXT, "songs");
